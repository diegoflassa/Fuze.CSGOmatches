...
open class DialogState(
    ...
    fun ExibirDialog() {
        return AlertDialog(
            ...
            iconContentColor = iconContentColor
                ?: FuseCSGOMatchesTheme.colorScheme.onSecondaryContainer,
            titleContentColor = titleContentColor
                ?: FuseCSGOMatchesTheme.colorScheme.onSecondaryContainer,
            textContentColor = textContentColor
                ?: FuseCSGOMatchesTheme.colorScheme.onSecondaryContainer,
...
val colorsButtonDialog = ButtonColors(
    containerColor = FuseCSGOMatchesColors.primaryContainer,
    contentColor = Color.White,
    disabledContainerColor = FuseCSGOMatchesColors.primaryContainer,
    disabledContentColor = FuseCSGOMatchesColors.primaryContainer,
)
...
fun ButtonDialog(
    ...
    buttonBackground: Color = FuseCSGOMatchesTheme.colorScheme.primaryContainer,
    onClick: (() -> Unit)? = null
) {
    Button(
